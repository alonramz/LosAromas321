  ...
  <div className="row">
        ...
        <form action="/action_page.php">
          ...
          <div className="row">
            <div className="col-2">
              ...
              <input type="text" id="adr" nameName="address" placeholder="123 W. Street"/>
              ...
              <div className="row">
                ...
                <div className="col-2">
                  ...
                  <input type="text" id="zip" name="zip" placeholder="28210"/>
                </div>
              </div>
            </div>
            ...
            <div className="col-2">
              ...
              <input type="text" id="cname" name="cardname" placeholder="Fat Stacks"/>
    ...
    <div className="col-3">
      <div className="container">
        ...
        <p><a href="/">Product 3</a> <span className="price">$10</span></p>
        <p><a href="/">Product 4</a> <span className="price">$10</span></p>
        <hr/>
